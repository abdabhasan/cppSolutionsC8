...
/*
    write a progeram to read a Vacation start dateFrom
    and vacationDays, then make a function to calc the vacation
    return date;
...
short readVacationDays(){
    ...
    cout << "Please Enter a vacation Days " << endl;
    cin >> num;
...
stDate calculateVacationReturnDate(stDate startDate, short days){
...
int main(){
    ...
    stDate returnDate = calculateVacationReturnDate(date1, vacationDays);
